...
class DB_Operations:
    ...
    def selectDataFromCollection_into_csv(self, collection_object):
        ...
        try:
            ...
            file = open("Predication_Logs/DataBase_Into_CSVLog.txt", 'a+')
